...
public class InterFaceDemo2 {
	...
	public static void main(String[] args) {
		//1. Anonymous 2. Method Referencing 3. Lambda 4. Muthu teacher
				...
				//Method Referencing...
				FInterOne one=InterFaceDemo2::mymethod;
				one.met();
				...
				//Method referencing
				FInterTwo two=new InterFaceDemo2()::mymethod2;
				value=two.met();
				...
				//Method Referencing
				FInterThree three=new InterFaceDemo2()::mymethod3;
				...
				//Method Referencing
				FInterFour four=new InterFaceDemo2()::mymethod4;
